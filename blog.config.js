...
const BLOG = {
  ...
  FONT_AWESOME_PATH:
    'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.1.1/css/all.min.css', // 图标库CDN ，国内推荐BootCDN，国外推荐 CloudFlare https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '南半球的搬砖人', // 站点描述，被notion中的页面描述覆盖
